import { gray, yellow, blue, dim, cyan, red, green, bold, reset, underline } from 'kolorist';
import yargs from 'yargs';
import { hideBin } from 'yargs/helpers';
import { join, isAbsolute, parse, dirname } from 'path';
import { createRequire } from 'module';
import fs from 'fs-extra';
import { resolveConfig, build as build$1 } from 'vite';
import { JSDOM } from 'jsdom';
import { s as serializeState } from '../chunks/state.mjs';
...
async function build(cliOptions = {}) {
  ...
  if (mock) {
    const jsdomGlobal = (await import('../chunks/jsdomGlobal.mjs')).default;
    jsdomGlobal();
  }
