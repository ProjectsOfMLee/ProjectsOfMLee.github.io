...
async function build(cliOptions = {}) {
  ...
  const config = await vite.resolveConfig({}, "build", mode);
  ...
  const _require = module$1.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('node/cli.cjs', document.baseURI).href)));
  ...
  if (mock) {
    const jsdomGlobal = (await import('../chunks/jsdomGlobal.cjs')).default;
    jsdomGlobal();
  }
