...
var routeBlockQueryRE = /\.vue\?vue&type=route/;
var dynamicRouteRE = /^\[(.+)\]$/;
...
function prepareRoutes2(ctx, routes, parent) {
  ...
  for (const route of routes) {
    ...
    Object.assign(route, ((_c = (_b = ctx.options).extendRoute) == null ? void 0 : _c.call(_b, route, parent)) || {});
  }
  return routes;
}
...
function pagesPlugin(userOptions = {}) {
  ...
  return {
    ...
    async configResolved(config) {
      ...
      if (jsonPlugin) {
        const jsonTransform = jsonPlugin.transform;
