...
interface ResolvedOptions extends Omit<Options, 'pagesDir' | 'replaceSquareBrackets'> {
    /**
...
export { CustomBlock, ImportMode, ImportModeResolveFn, Optional, PageContext, PageOptions, ReactRoute, ResolvedOptions, SolidRoute, SupportedPagesResolver, UserOptions, VueRoute, pagesPlugin as default };
